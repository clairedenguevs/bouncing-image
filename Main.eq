...
public class Main : SEScene    
{
    ...
    {
        base.initialize(rsc);
        bg=add_sprite_for_color(Color.instance("pink"),get_scene_width(),get_scene_height());
        bg.move(0,0);
       // fg = add_sprite_for_color(Color.instance("violet"),get_scene_width()*0.1,get_scene_height()*0.1);
       // fg.move(100,00);
		...
		rsc.prepare_image("myimage", "a", get_scene_width()*0.1);
